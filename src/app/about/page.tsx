        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mx-auto mt-12 grid max-w-7xl grid-cols-1 gap-8 sm:grid-cols-2 sm:gap-10 lg:grid-cols-4 lg:gap-12">
            ...
            <div key={leader.name} className="group">
                ...
                <p className="mt-1 text-sm font-medium bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent sm:text-base !whitespace-pre-line !whitespace-pre-line !whitespace-pre-line !whitespace-pre-line">{leader.role}</p>
